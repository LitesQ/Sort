...
try:
    ...
    for i in range(len(result)):
        ...
        #print(incriment,"'"+last_name+"'","'"+first_name+"'","'"+patronymic+"'","'"+last_name + " " + first_name + " " + patronymic+"'","'"+birth_date+"'","'"+birth_region+"'","'"+street+"'","'"+home+"'","'"+korpus+"'","'"+""+"'","'"+kvartira+"'","'"+""+"'","'"+sex+"'","'"+citizenship+"'","'"+doc_type+"'","'"+serial+"'","'"+numb+"'","'"+serial+numb+"'","'"+doc_org+"'","'"+doc_date+"'","'"+"Постоянная"+"'","'"+description+"'","'"+""+"'","'"+""+"'")
